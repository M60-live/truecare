    ...
    <div class="container">
        <div class="row" style="padding: 5.6em 0;">
            ...
            <div class="col col-md-3 col-sm-6">
                ...
                <ul class="list-unstyled text-center">
                    <li><a href="/shop/category" class="text-white nav-link">Teas</a></li>
                    <li><a href="/shop/category" class="text-white nav-link">Tooth Paste</a></li>
                    <li><a href="/shop/category" class="text-white nav-link">Juices</a></li>
                </ul>
            </div>
